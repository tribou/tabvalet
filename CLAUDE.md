...
4. **Bug fixes require TDD tests**: Any bug fix must be preceded by a failing unit or integration test demonstrating the issue. See [docs/TESTING.md](file:///Users/tribou/dev/joyful-pascal/docs/TESTING.md) for full TDD testing policies.
...
- [docs/ARCHITECTURE.md](file:///Users/tribou/dev/joyful-pascal/docs/ARCHITECTURE.md) - *What is this system? — components, data flow, DB schema, external APIs, and directory layout*
- [docs/DEVELOPMENT.md](file:///Users/tribou/dev/joyful-pascal/docs/DEVELOPMENT.md) - *How do we write code here? — naming conventions, design principles, error handling, reliability strategy, and planned stack*
- [docs/PRODUCT.md](file:///Users/tribou/dev/joyful-pascal/docs/PRODUCT.md) - *What are we building and why? — user story, requirements, success criteria, and business domain context helpful for understanding why features are built the way they are*
- [docs/SECURITY.md](file:///Users/tribou/dev/joyful-pascal/docs/SECURITY.md) - *How do we keep secrets safe? — environment variables, API key policy, and auth posture*
- [docs/TESTING.md](file:///Users/tribou/dev/joyful-pascal/docs/TESTING.md) - *How do we test and fix bugs? — testing requirements, test running instructions, and bug fix policies.*
